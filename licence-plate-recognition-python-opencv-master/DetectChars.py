...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("D:\Code\Python\practice_everyting\ML\licence-plate-recognition-python-opencv-master\classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("D:\Code\Python\practice_everyting\ML\licence-plate-recognition-python-opencv-master\\flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
